...
#ifndef ESTRUTURAS_FILA_ESTATICA_LINEAR_MENU
#define ESTRUTURAS_FILA_ESTATICA_LINEAR_MENU
...
/* essa função testa a fila estatica de forma automatica */
void testar_fila_estatica_automatico(void);

#endif /* ESTRUTURAS_FILA_ESTATICA_LINEAR_MENU */
