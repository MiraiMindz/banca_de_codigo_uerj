...
#ifndef ESTRUTURAS_PILHA_FIXA_LINEAR_MACROS
#define ESTRUTURAS_PILHA_FIXA_LINEAR_MACROS

#include <config/config.h>

/* Essa é uma medida de segurança para impedir que MACRO_PILHA_FIXA_LINEAR_CODIGO
   não seja re-definido caso tenha sido definido anteriormente */
#ifdef MACRO_PILHA_FIXA_LINEAR_CODIGO
...
/* Esses macros usados através do código para refletir a mudança no tipo da
   ...
   MACRO_PILHA_FIXA_LINEAR_CODIGO no arquivo config/config.h */
#if MACRO_PILHA_FIXA_LINEAR_CODIGO == 0
#define MACRO_PILHA_FIXA_LINEAR_TIPO signed char
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 1
#define MACRO_PILHA_FIXA_LINEAR_TIPO signed short
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 2
#define MACRO_PILHA_FIXA_LINEAR_TIPO signed int
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 3
#define MACRO_PILHA_FIXA_LINEAR_TIPO signed long
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 4
#define MACRO_PILHA_FIXA_LINEAR_TIPO unsigned char
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 5
#define MACRO_PILHA_FIXA_LINEAR_TIPO unsigned short
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 6
#define MACRO_PILHA_FIXA_LINEAR_TIPO unsigned int
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 7
#define MACRO_PILHA_FIXA_LINEAR_TIPO unsigned long
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 8
#define MACRO_PILHA_FIXA_LINEAR_TIPO char
#define PRINTF_FORMAT_STR "O valor removido foi: %hhd\n"
#define SCANF_FORMAT "%hhd"
#define SHOW_STRING0A "%-16lu"
#define SHOW_STRING0B "%-39hhd"
...
#define SHOW_STRING3 "%-76hhd"
#define SHOW_STRING4 "%hhd"
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 9
#define MACRO_PILHA_FIXA_LINEAR_TIPO short
#define PRINTF_FORMAT_STR "O valor removido foi: %hd\n"
#define SCANF_FORMAT "%hd"
#define SHOW_STRING0A "%-16lu"
#define SHOW_STRING0B "%-39hd"
...
#define SHOW_STRING3 "%-76hd"
#define SHOW_STRING4 "%hd"
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 10
#define MACRO_PILHA_FIXA_LINEAR_TIPO int
#define PRINTF_FORMAT_STR "O valor removido foi: %d\n"
#define SCANF_FORMAT "%d"
#define SHOW_STRING0A "%-16lu"
#define SHOW_STRING0B "%-39d"
...
#define SHOW_STRING3 "%-76d"
#define SHOW_STRING4 "%d"
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 11
#define MACRO_PILHA_FIXA_LINEAR_TIPO long
#define PRINTF_FORMAT_STR "O valor removido foi: %ld\n"
#define SCANF_FORMAT "%ld"
#define SHOW_STRING0A "%-16lu"
#define SHOW_STRING0B "%-39ld"
...
#define SHOW_STRING3 "%-76ld"
#define SHOW_STRING4 "%ld"
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 12
#define MACRO_PILHA_FIXA_LINEAR_TIPO float
...
#elif MACRO_PILHA_FIXA_LINEAR_CODIGO == 13
#define MACRO_PILHA_FIXA_LINEAR_TIPO double
#define PRINTF_FORMAT_STR "O valor removido foi: %f\n"
#define SCANF_FORMAT "%f"
#define SHOW_STRING0A "%-16lu"
#define SHOW_STRING0B "%-39f"
...
#define SHOW_STRING4 "%f"
#else
#error "Tipo de MACRO_PILHA_FIXA_LINEAR_TIPO não reconhecido"
#error "Tipo Não Reconhecido para SCANF_FORMAT"
#error "Tipo Não Reconhecido para MACRO_PILHA_FIXA_LINEAR_TIPO"
#error "Tipo Não Reconhecido para PRINTF_FORMAT_STR"
#endif
#endif

#endif /* ESTRUTURAS_PILHA_FIXA_LINEAR_MACROS */
